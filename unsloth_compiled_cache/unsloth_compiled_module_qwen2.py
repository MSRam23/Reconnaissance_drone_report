...
from transformers.models.qwen2.modeling_qwen2 import (Callable, Optional, Tuple, Union, torch, nn, ACT2FN, Cache, GenerationMixin, use_kernel_forward_from_hub, FlashAttentionKwargs, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, add_start_docstrings, add_start_docstrings_to_model_forward, can_return_tuple, replace_return_docstrings, deprecate_kwarg, Qwen2Config, logger, __name__, _CONFIG_FOR_DOC, Qwen2PreTrainedModel, QWEN2_INPUTS_DOCSTRING, Qwen2Model, KwargsForCausalLM, Qwen2ForCausalLM)
...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        return Qwen2Attention_forward(self, hidden_states, position_embeddings, attention_mask, past_key_value, cache_position, **kwargs)
...
class Qwen2RotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        return Qwen2RotaryEmbedding_forward(self, x, position_ids)
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        return Qwen2ForCausalLM_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, labels, use_cache, output_attentions, output_hidden_states, cache_position, logits_to_keep, **kwargs)
