...
from transformers.models.qwen2_vl.modeling_qwen2_vl import (F, math, Any, Dict, List, Optional, Tuple, Union, torch, nn, CrossEntropyLoss, LayerNorm, ACT2FN, Cache, GenerationMixin, AttentionMaskConverter, flash_attn_supports_top_left_mask, ROPE_INIT_FUNCTIONS, dynamic_rope_update, PreTrainedModel, add_start_docstrings, add_start_docstrings_to_model_forward, replace_return_docstrings, Qwen2VLConfig, logger, __name__, _CONFIG_FOR_DOC, Qwen2VLCausalLMOutputWithPast, Qwen2VLModel, Qwen2VLPreTrainedModel, Qwen2VisionTransformerPretrainedModel, QWEN2_VL_INPUTS_DOCSTRING, Qwen2VLForConditionalGeneration)
...
class VisionAttention(nn.Module):
    ...
    def forward(
        ...
        return VisionAttention_forward(self, hidden_states, cu_seqlens, rotary_pos_emb, position_embeddings)
...
class VisionFlashAttention2(nn.Module):
    ...
    def forward(
        ...
        return VisionFlashAttention2_forward(self, hidden_states, cu_seqlens, rotary_pos_emb, position_embeddings)
